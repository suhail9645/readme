...
import 'package:read_me/presentation/pages/profile_section/profile.dart';
  ...
  static Future updateUser(String username, String fullName, File? photo,
    ...
    if (isNewUser) {
      if (photo != null) {
        ...
        fireRef.delete();
        final fireStorage =
            FirebaseStorage.instance.ref().child('$username/image.$extension');
      ...
      RegisterFunction.getUserDetailes(user.uid).whenComplete(
      ...
      ScaffoldMessenger.of(context).showSnackBar(
          CustomSnackBar(contentText: 'This username already using one'));
    }
  }
}
